...
<div class="about-author clearfix">
	<div class="media">
		<a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" class="pull-left">
			<?php
				echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'eyewear_author_bio_avatar_size', 150 ) );
			?>
		</a>
				...
				<div class="author-links">
					<a class="author-post"
					   href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>">
						<i class="zmdi zmdi-sort-amount-desc zmdi-hc-fw"></i> <?php esc_html_e( 'Post', 'eyewear' ); ?>
					</a>
					<?php if ( get_the_author_meta( 'user_url' ) ) : ?>
						<a class="author-web" href="<?php echo esc_url( get_the_author_meta( 'user_url' ) ); ?>"
						   target="_blank">
							<i class="zmdi zmdi-globe zmdi-hc-fw"></i> <?php esc_html_e( 'Web', 'eyewear' ); ?>
						</a>
					<?php endif ?>
