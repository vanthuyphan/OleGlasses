...
<div class="pagination-wrap clearfix">
	<nav class="row navigation next-previous-post <?php echo esc_attr( $has_author_meta_class ) ?>" role="navigation">
		<?php if ( $previous ) : ?>
			<div class="col-xs-6 previous-post">
				<?php previous_post_link( '<div class="previous">%link</div>', '<i class="zmdi zmdi-long-arrow-left zmdi-hc-fw"></i>' . esc_html__( 'Prev', 'eyewear' ) ); ?>
		...
		<?php if ( $next ) : ?>
			<div class="col-xs-6 next-post">
				<?php next_post_link( '<div class="next">%link</div>', esc_html__( 'Next', 'eyewear' ) . '<i class="zmdi zmdi-long-arrow-right zmdi-hc-fw"></i>' ); ?>
				<div class="entry-title">
					<h3>
