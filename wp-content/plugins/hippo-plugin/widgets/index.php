<?php
    ...
    class Hippo_Recent_Post_Widget extends WP_Widget
    {
        ...
        {
            parent::__construct(
                'hippo_recent_post', // Base ID
                __('Hippo Recent Posts', 'hippo-plugin'), // Name
                        ...
                        if ($the_query->have_posts()) {
                            while ($the_query->have_posts()) {
                                ...
                                <div class="media">
                                    ...
                                    <?php
                                        $image_thumb = array($instance[ 'thumb_width' ], $instance[ 'thumb_height' ]);
                                            ...
                                            if (has_post_thumbnail()) { ?>
                                                <div class="media-left">
                                                    <a class="post-thumb" href="<?php the_permalink(); ?>">
                                                        <img class="media-object recent-post-tab-thumb-image" src="<?php echo esc_url($image[ 0 ]); ?>"
                                                        ...
                                                        <ul class="list-inline">
                                                            ...
                                                            <li>
                                                                <span class="post-author">
                                                                    <?php esc_html_e('By', 'hippo-plugin');?> <?php printf('<a class="url fn n" href="%1$s">%2$s</a>', esc_url(get_author_posts_url(get_the_author_meta('ID'))), esc_html(get_the_author())) ?>
                                                                </span>
                                                            </li>
                                                        </ul>
                                                    </div>
    ...
    class Hippo_Latest_Tweet_Widget extends WP_Widget
    {
        ...
        {
            parent::__construct(
                'hippo_latest_tweet', // Base ID
                __('Hippo latest tweet', 'hippo-plugin'), // Name
        ...
        public function widget($args, $instance)
        {
            ...
            <div class="twitterWidget" data-widget-id="<?php echo esc_attr($instance[ 'widget_id' ]); ?>" data-max-tweet="<?php echo esc_attr($instance[ 'max_tweet' ]); ?>">
    ...
    // register widgets
    if (!function_exists('hippo_latest_tweet_widgets')) {
        function hippo_latest_tweet_widgets()
        {
            register_widget('Hippo_Latest_Tweet_Widget');
        }

        add_action('widgets_init', 'hippo_latest_tweet_widgets');
    }
    ...
    class Hippo_Flickr_Photo_Widget extends WP_Widget
    {
        ...
        {
            parent::__construct(
                'hippo_flickr_photo', // Base ID
                __('Hippo Flickr Photo', 'hippo-plugin'), // Name
    ...
    // register widgets
    if (!function_exists('hippo_flickr_photo_widgets')) {
        function hippo_flickr_photo_widgets()
        {
            register_widget('Hippo_Flickr_Photo_Widget');
        }

        add_action('widgets_init', 'hippo_flickr_photo_widgets');
    }