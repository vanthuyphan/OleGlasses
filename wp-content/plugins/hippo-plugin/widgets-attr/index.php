	...
	class Hippo_Widget_Attrs {
		...
		public function form( $widget, $return, $instance ) {
			...
			<p><input value="1" <?php checked( '1', $clear ) ?>
			          ...
			          name="<?php echo $widget->get_field_name( 'hippo_bs_grid_clear' ) ?>" type="checkbox">&nbsp;<label
		...
		public function display( $params ) {
			...
			if ( preg_match( '/class="/', $params[ 0 ][ 'before_widget' ] ) ) {
				...
				$default_grid_classes = apply_filters( 'hippo_plugin_widget_grid_class_to_remove', array() );
