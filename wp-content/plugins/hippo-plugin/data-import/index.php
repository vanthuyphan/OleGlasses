<?php
	...
	function hippo_demodata_toolbar() {
		...
		$args = array(
			'id'    => 'hippo-installer',
			'title' => sprintf( esc_html__( '%s Theme Setup Wizard', 'hippo-plugin' ), HIPPO_PLUGIN_THEME_NAME ),
			'href'  => admin_url( sprintf( 'themes.php?page=%s-setup', strtolower( HIPPO_PLUGIN_THEME_NAME ) ) ),
		);
