<?php
	 ...
	 */
	function hippo_plugin_add_term_meta( $term_id, $meta_key, $meta_value, $unique = FALSE ) {
	 ...
	 * @return bool False for failure. True for success.
	 */
	function hippo_plugin_delete_term_meta( $term_id, $meta_key, $meta_value = '' ) {
	 ...
	 */
	function hippo_plugin_delete_term_meta_by_key( $term_meta_key ) {
	 ...
	 */
	function hippo_plugin_get_term_meta( $term_id, $key, $single = FALSE ) {
	 ...
	 */
	function hippo_plugin_update_term_meta( $term_id, $meta_key, $meta_value, $prev_value = '' ) {
	 ...
	 */
	function hippo_plugin_taxonomy_metadata_wpdbfix() {
		global $wpdb;
	...
	add_action( 'init', 'hippo_plugin_taxonomy_metadata_wpdbfix', 0 );
	add_action( 'switch_blog', 'hippo_plugin_taxonomy_metadata_wpdbfix', 0 );
