<?php
	...
	$fields = array(
		...
		array(
			'label'     => NULL, // <label>
			'desc'      => __( 'Featured Quote Text', 'hippo-plugin' ), // description
			'id'        => $prefix . 'featured_quote_text', // field id and name
	 ...
	 * var $js bool including javascript or not
	 */
	new Hippo_Custom_Add_Meta_Box( 'post_quote_meta', __( 'Featured Quote Texts', 'hippo-plugin' ), $fields, 'post', TRUE );
	...
	$fields = array(
		...
		array(
			'label'     => NULL, // <label>
			'desc'      => __( 'Featured Link Text', 'hippo-plugin' ), // description
			'id'        => $prefix . 'featured_link_text', // field id and name
			'type'      => 'editor', // type of field
			'settings'  => array( 'media_buttons' => FALSE ),
			'sanitizer' => 'wp_kses_post'
		)
	 ...
	 * var $js bool including javascript or not
	 */
	new Hippo_Custom_Add_Meta_Box( 'post_link_meta', __( 'Featured Link Text', 'hippo-plugin' ), $fields, 'post', TRUE );

	$fields = array(

		array(
			'label'     => NULL, // <label>
			'desc'      => __( 'Featured Status Text', 'hippo-plugin' ), // description
			'id'        => $prefix . 'featured_status_text', // field id and name
			'type'      => 'editor', // type of field
			'settings'  => array( 'media_buttons' => FALSE ),
			'sanitizer' => 'wp_kses_post'
		)
	 ...
	 * var $js bool including javascript or not
	 */
	new Hippo_Custom_Add_Meta_Box( 'post_status_meta', __( 'Featured Status Text', 'hippo-plugin' ), $fields, 'post', TRUE );
