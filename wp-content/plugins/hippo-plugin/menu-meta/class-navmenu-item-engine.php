<?php
	...
	class Hippo_Menu_Item_Meta_Engine {
		...
		public function setup() {
			...
			$fields = apply_filters( 'hippo_plugin_nav_menu_item_meta', self::getInstance()->_fields );
	...
	if ( ! function_exists( 'hippo_plugin_get_menu_meta' ) ) :
		function hippo_plugin_get_menu_meta( $id, $name, $default = NULL ) {
 ...
 *
 *
 *    add_filter('hippo_plugin_nav_menu_item_meta', function ($fields) {
 *
 * $fields[ 'menucolumnclass' ] = array(
 * 'type'       => 'text',
 * 'label'      => esc_html__( 'Mega Menu Column Class', 'text-domain' ),
 * 'default'    => 'col-md-10',
 * 'depth'      => 0,
 * 'dependency' => array(
