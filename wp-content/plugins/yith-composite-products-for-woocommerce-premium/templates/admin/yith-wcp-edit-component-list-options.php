...
<div class="ywcp_components_list_container ywcp_list_container" >
    ...
    <p class="toolbar">
        ...
        <span class="expand-close">
            ...
            <a href="#" class="ywcp_expand_all"><?php _e( 'Expand all', 'yith-composite-products-for-woocommerce' ); ?></a> / <a href="#"
                                                                                                                             class="ywcp_close_all"><?php _e( 'Collapse all', 'yith-composite-products-for-woocommerce' ); ?></a>
