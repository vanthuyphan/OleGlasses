...
if ( ! class_exists( 'YITH_WCP' ) ) {
    ...
    class YITH_WCP {
        ...
        public function getProductsQueryArgs( $post_id , $wcp_data_single_item , $post_per_page = -1 , $current_page = 1 , $custom_order_by = 'menu_order' , $custom_order = 'asc' ) {
            ...
            $stock_query = WC()->query->stock_status_meta_query();
            ...
            $args['meta_query']['stock_status'] = apply_filters( 'ywcp_stock_status_meta_query' , $stock_query );
            ...
            switch ( $wcp_data_single_item['option_type'] ) {
                ...
                case 'product_categories' :
                    $args['product_cat'] = implode( ',', $wcp_data_single_item['option_type_cat_id_values'] );
                    break;
                case 'product_tags' :
                    $args['product_tag'] = implode( ',', $wcp_data_single_item['option_type_tag_id_values'] );
                    break;
            }
