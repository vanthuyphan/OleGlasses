 ...
 * Description: Allow your customers to assemble their own product using other products from your store.
 * Version: 1.0.10
 * Author: YITHEMES
...
! defined( 'YITH_WCP_VERSION' ) && define( 'YITH_WCP_VERSION', '1.0.10' );
