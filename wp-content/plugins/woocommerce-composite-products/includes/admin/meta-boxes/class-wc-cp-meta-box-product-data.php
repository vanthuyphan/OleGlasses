		...
		?><div class="options_group bundle_group bto_clearfix">
			...
			<div class="bto_layouts bto_clearfix form-field">
				<label class="bundle_group_label">
					<?php _e( 'Composite Layout', 'woocommerce-composite-products' ); echo wc_help_tip( __( 'Choose a layout for this Composite product.', 'woocommerce-composite-products' ) ); ?>
				</label>
		...
		?><div class="options_group config_group bto_clearfix">
			<p class="toolbar">
				<span class="options_group_h3">
					<?php _e( 'Components', 'woocommerce-composite-products' ); echo wc_help_tip( __( '<strong>Components</strong> are the building blocks of a Composite product. Use Components to define the discrete parts of a Composite product.', 'woocommerce-composite-products' ) ); ?>
				</span>
