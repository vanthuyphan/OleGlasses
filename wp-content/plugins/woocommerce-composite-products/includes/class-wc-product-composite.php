...
class WC_Product_Composite extends WC_Product {
	...
	*/
	...
	public function get_scenario_data( $context = 'view' ) {
		...
		$composite_scenario_meta = $this->scenario_meta;
		 ...
		 * @param  WC_Product_Composite  $product
		 */
		return 'view' === $context ? apply_filters( 'woocommerce_composite_scenario_meta', $composite_scenario_meta, $this ) : $composite_scenario_meta;
	}
