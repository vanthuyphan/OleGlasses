...
?><div class="component_data woocommerce-error" data-price="0" data-regular_price="0" data-product_type="invalid-product"><?php
	...
	if ( $is_static ) {
		...
		$link = '<a class="clear_component_options button" href="#">' . __( 'Clear selection', 'woocommerce-composite-products' ) . '</a>';
		$html = sprintf( __( 'The selected item cannot be purchased at the moment. %s', 'woocommerce-composite-products' ), $link );
	}
