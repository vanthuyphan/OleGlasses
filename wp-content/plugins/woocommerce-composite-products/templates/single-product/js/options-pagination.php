...
?><script type="text/template" id="tmpl-wc_cp_options_pagination">
	...
	<nav class="woocommerce-pagination">
		<ul class="page-numbers">
			...
			<# if ( data.page > 1 ) { #>
				<li><a class="page-numbers component_pagination_element previous" data-page_num="{{ data.page - 1 }}" href='#'><?php echo _x( '&larr;', 'options pagination previous', 'woocommerce-composite-products' ); ?></a></li>
			<# } #>
			...
			<# if ( data.page < data.pages ) { #>
				<li><a class="page-numbers component_pagination_element first" data-page_num="{{ data.page + 1 }}" href='#'><?php echo _x( '&rarr;', 'options pagination next', 'woocommerce-composite-products' ); ?></a></li>
			<# } #>
